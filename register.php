                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_POST['register'])) {
                                        ...
                                        $insert = mysqli_query($koneksi, "INSERT INTO userid(username,email,NamaLengkap,alamat,password,level) Values('$username','$email','$nama','$alamat','$password','$level')");
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" type="text" required type="text" name="email" placeholder="Masukkan Email" />
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1">Nama Lengkap</label>
                                            <input class="form-control py-4" type="text" required name="NamaLengkap" placeholder="Masukkan Nama Lengkap" />
                                        </div>
                                        <div class="form-group">
